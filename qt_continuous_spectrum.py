...
class Window(QtGui.QMainWindow):
	...
	def home(self):
		...
		# quit = QtGui.QAction(QtGui.QIcon('todachoppa.png'), 'Flee the scene', self)
		# quit.triggered.connect(sys.exit)
	...
	def update_plot(self):
		...
		freq = np.random()
		y = np.cos(freq*x)
		self.pData.setData(x, y, clear=True)
...
#     win = pg.GraphicsWindow(title='Spectrum Trace')
#     win.resize(1000,600)
#     sPlot = win.addPlot()
...
#         """#################SPECTRUM PLOT#################"""
#         pg.plot(freq, np.array(traceData))
